...
// --- 2. Teammitglieder -----------------------
Johannes Hanko <s84268@htw-dresden.de>; Hai Van Nguyen <s86039@htw-dresden.de>; Yannick Birnbaum <s85542@htw-dresden.de>; Ali Al Mahdi <s85556@htw-dresden.de>; Zakaria Lehmadi <s85625@htw-dresden.de>; Marc-Leon Vogt <s85521@htw-dresden.de>; Mateo Thürig <s85638@htw-dresden.de>; Sten Mende <s85468@htw-dresden.de>
// --- 3. Abgabedatum --------------------------
26. Januar 2024
// ---------------------------------------------
:docs: ../docs
...
<<<
// Iteration 4
include::{docs-project-management}/iterationsplan_I04.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
// Iteration 5
include::{docs-project-management}/iterationsplan_I05.adoc[lines=1..1;4..-1,leveloffset=+1]
<<<
